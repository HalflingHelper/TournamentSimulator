...
const rounds = [
    new Round([
        new Game(players[1], players[0]).setResult(GameResults.BLACK),
        new Game(players[3], players[2]).setResult(GameResults.DRAW),
    ...
    new Round([
        new Game(players[3], players[0]).setResult(GameResults.DRAW),
        new Game(players[5], players[1]).setResult(GameResults.DRAW),
        new Game(players[7], players[2]).setResult(GameResults.DRAW),
        new Game(players[9], players[4]).setResult(GameResults.DRAW),
        new Game(players[8], players[6]).setResult(GameResults.DRAW),
    ]),
    new Round([
        new Game(players[0], players[6]).setResult(GameResults.WHITE),
        new Game(players[4], players[8]).setResult(GameResults.DRAW),
        new Game(players[2], players[9]).setResult(GameResults.WHITE),
        new Game(players[1], players[7]).setResult(GameResults.DRAW),
        new Game(players[3], players[5]).setResult(GameResults.DRAW),
    ]),
    new Round([
        new Game(players[5], players[0]).setResult(GameResults.DRAW),
        new Game(players[7], players[3]).setResult(GameResults.DRAW),
        new Game(players[9], players[1]).setResult(GameResults.DRAW),
        new Game(players[8], players[2]).setResult(GameResults.DRAW),
        new Game(players[6], players[4]).setResult(GameResults.DRAW),
    ]),
    new Round([
        new Game(players[0], players[4]).setResult(GameResults.DRAW),
        new Game(players[2], players[6]).setResult(GameResults.DRAW),
        new Game(players[1], players[8]).setResult(GameResults.WHITE),
        new Game(players[3], players[9]).setResult(GameResults.DRAW),
        new Game(players[5], players[7]).setResult(GameResults.DRAW),
    ]),
    new Round([
